...
import { useAccount, useAccountOptional } from './contexts/AccountContext'
import { AuthProvider } from './contexts/AuthProvider'
import { useAuth } from './contexts/AuthContext'
import { BrandProvider } from './contexts/BrandProvider'
import { useBrand } from './contexts/BrandContext'
import { ThemeProvider } from './contexts/ThemeProvider'
import { MiniPlayer } from './components/news/MiniPlayer'
import { ArticleReaderMiniPlayer } from './components/news/ArticleReaderMiniPlayer'
import { RiskDisclaimer } from './components/shared/RiskDisclaimer'
import { AboutModal } from './components/AboutModal'
import { DonationModal } from './components/DonationModal'
import { shouldShowDonationModal } from './components/donationSchedule'
import { EmailVerificationPending } from './components/auth/EmailVerificationPending'
import { MFAEncouragement, MFA_DISMISSED_KEY } from './components/auth/MFAEncouragement'
import { SessionLimitsNotice } from './components/settings/SessionLimitsNotice'
        ...
        <div className={`border-b border-slate-700 bg-gradient-to-r ${headerGradient} transition-colors duration-1000`}>
          <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
            ...
            <div className="hidden lg:flex flex-row items-center justify-between">
              ...
              {seasonInfo && (
                <div className={`hidden lg:flex items-center space-x-1.5 px-3 py-2 mr-6 rounded-lg border h-[38px] ${
