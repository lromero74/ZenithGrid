...
export function PaperTradingToggle() {
  ...
  return (
    <div className="relative flex items-center justify-center space-x-1.5 sm:space-x-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-slate-700 rounded-lg border border-slate-600 min-w-[200px]">
      {/* Live Trading Icon */}
