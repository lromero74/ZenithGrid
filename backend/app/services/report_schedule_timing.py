"""Report schedule timing math — next-run and period-bounds computation.

Pure date/calendar helpers extracted from report_scheduler so neither module
exceeds the size limit. No DB or I/O — just schedule arithmetic over
ReportSchedule rows.
"""
