    ...
    return StrategyDefinition(
        ...
        parameters=[
            ...
            StrategyParameter(
                ...
                description="If 'percentage': % of per-position budget. If 'fixed': exact amount in quote currency (BTC or USD).",
                type="float",
                default=40.0,
                min_value=1.0,
                max_value=100.0,
            ...
            StrategyParameter(
                ...
                description="Size of first DCA order. Subsequent orders are multiplied by DCA Order Multiplier.",
                type="float",
                default=20.0,
                min_value=1.0,
                max_value=100.0,
