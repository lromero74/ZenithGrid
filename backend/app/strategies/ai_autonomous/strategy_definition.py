    ...
    return StrategyDefinition(
        ...
        parameters=[
            ...
            StrategyParameter(
                ...
                description="How aggressive should the AI be? Conservative: more selective, higher confidence thresholds. Moderate: balanced approach. Aggressive: more trades, lower confidence thresholds.",
                type="string",
                default="moderate",
            ...
            StrategyParameter(
                ...
                description="Minimum AI confidence required to open a new position. Leave empty to use Risk Tolerance defaults (Conservative=80, Moderate=75, Aggressive=70).",
                type="int",
                default=None,
                min_value=50,
                max_value=100,
                required=False,
                group="AI Confidence Thresholds",
            ),
            StrategyParameter(
                name="min_confidence_for_dca",
                display_name="Min AI Confidence for DCA (%)",
                description="Minimum AI confidence required to execute DCA orders. Leave empty to use Risk Tolerance defaults (Conservative=75, Moderate=70, Aggressive=65).",
                type="int",
                default=None,
                min_value=50,
                max_value=100,
            ...
            StrategyParameter(
                ...
                description="Minimum AI confidence required to close a position. Leave empty to use Risk Tolerance defaults (Conservative=70, Moderate=65, Aggressive=60).",
                type="int",
                default=None,
                min_value=50,
                max_value=100,
