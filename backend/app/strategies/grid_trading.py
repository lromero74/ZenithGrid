...
# ---------------------------------------------------------------------------
# Grid Trading strategy parameter definitions (data-driven config)
...
_GRID_PARAMS = [
    ...
    {"name": "grid_type", "display_name": "Grid Type",
     ...
     "type": "string", "default": "arithmetic",
     "options": ["arithmetic", "geometric"],
     "group": "grid_config", "required": True},
    {"name": "grid_mode", "display_name": "Grid Mode",
     "description": "Trading direction (neutral: buy+sell, long: buy only)",
     "type": "string", "default": "neutral",
     "options": ["neutral", "long"],
     "group": "grid_config", "required": True},
    {"name": "range_mode", "display_name": "Range Setup",
     "description": "How to determine grid price range",
     "type": "string", "default": "manual",
     "options": ["manual", "auto_volatility", "hybrid_ai"],
     "group": "grid_config", "required": True},
    {"name": "upper_limit", "display_name": "Upper Price Limit",
     "description": "Maximum price for grid (manual mode)",
     "type": "float", "default": None,
     "min_value": 0.000001, "max_value": 999999,
     "group": "grid_config",
     "visible_when": {"range_mode": "manual"}, "required": False},
    {"name": "lower_limit", "display_name": "Lower Price Limit",
     "description": "Minimum price for grid (manual mode)",
     "type": "float", "default": None,
     "min_value": 0.000001, "max_value": 999999,
     "group": "grid_config",
     "visible_when": {"range_mode": "manual"}, "required": False},
    {"name": "auto_range_period_days", "display_name": "Volatility Analysis Period (days)",
     "description": "Historical period for auto-range calculation",
     "type": "int", "default": 30, "min_value": 7, "max_value": 90,
     "group": "grid_config",
     "visible_when": {"range_mode": "auto_volatility"}, "required": False},
    {"name": "range_buffer_percent", "display_name": "Range Buffer (%)",
     "description": "Safety margin beyond calculated range",
     "type": "float", "default": 5.0, "min_value": 0, "max_value": 20,
     "group": "grid_config",
     "visible_when": {"range_mode": "auto_volatility"}, "required": False},
    {"name": "num_grid_levels", "display_name": "Number of Grid Levels",
     "description": "Total buy + sell orders to place",
     "type": "int", "default": 20, "min_value": 5, "max_value": 100,
     "group": "grid_config", "required": True},
    # ── Investment ────────────────────────────────────────────────────────
    {"name": "total_investment_quote", "display_name": "Total Investment (Quote Currency)",
     "description": "Total capital to allocate to grid",
     "type": "float", "default": 0.01, "min_value": 0.0001, "max_value": 999999,
     "group": "investment", "required": True},
    # ── Advanced ──────────────────────────────────────────────────────────
    {"name": "enable_dynamic_adjustment", "display_name": "Enable Dynamic Breakout Handling",
     "description": "Automatically rebalance grid when price breaks out of range",
     "type": "bool", "default": True,
     "group": "advanced", "required": False},
    {"name": "breakout_threshold_percent", "display_name": "Breakout Threshold (%)",
     "description": "Price move beyond range to trigger rebalance",
     "type": "float", "default": 5.0, "min_value": 1.0, "max_value": 20.0,
     "group": "advanced",
     "visible_when": {"enable_dynamic_adjustment": True}, "required": False},
    {"name": "rebalance_cooldown_minutes", "display_name": "Rebalance Cooldown (minutes)",
     "description": "Minimum time between rebalances to prevent excessive adjustments in volatile markets",
     "type": "integer", "default": 15, "min_value": 0, "max_value": 60,
     "group": "advanced",
     "visible_when": {"enable_dynamic_adjustment": True}, "required": False},
    # ── Risk Management ───────────────────────────────────────────────────
    {"name": "stop_loss_percent", "display_name": "Stop Loss (%)",
     "description": "Exit grid if loss exceeds this percentage (0 = disabled)",
     "type": "float", "default": 0.0, "min_value": 0, "max_value": 50,
     "group": "risk_management", "required": False},
    # ── AI Optimization ───────────────────────────────────────────────────
    {"name": "enable_ai_optimization", "display_name": "Enable AI-Dynamic Optimization",
     "description": "Use AI to continuously optimize grid parameters based on performance",
     "type": "bool", "default": False,
     "group": "ai_optimization", "required": False},
    {"name": "ai_provider", "display_name": "AI Provider",
     "description": "AI service for grid optimization",
     "type": "string", "default": "anthropic",
     "options": ["anthropic", "openai", "gemini"],
     "group": "ai_optimization",
     "visible_when": {"enable_ai_optimization": True}, "required": False},
    {"name": "ai_model", "display_name": "AI Model",
     "description": "Specific AI model to use",
     "type": "string", "default": "claude-sonnet-4.5",
     "group": "ai_optimization",
     "visible_when": {"enable_ai_optimization": True}, "required": False},
    {"name": "ai_adjustment_interval_minutes", "display_name": "AI Check Interval (minutes)",
     "description": "How often AI analyzes and optimizes grid",
     "type": "int", "default": 120, "min_value": 15, "max_value": 1440,
     "group": "ai_optimization",
     "visible_when": {"enable_ai_optimization": True}, "required": False},
    {"name": "ai_analysis_depth", "display_name": "AI Analysis Depth",
     ...
     "visible_when": {"enable_ai_optimization": True}, "required": False},
    # ── Volume Weighting ──────────────────────────────────────────────────
    {"name": "enable_volume_weighting", "display_name": "Enable Volume-Weighted Levels",
     "description": "Place more grid levels at price zones with high trading volume",
     "type": "bool", "default": False,
     "group": "volume_weighting", "required": False},
    {"name": "volume_analysis_hours", "display_name": "Volume Analysis Period (hours)",
     "description": "Historical period to analyze trade volume distribution",
     "type": "int", "default": 24, "min_value": 6, "max_value": 168,
     "group": "volume_weighting",
     "visible_when": {"enable_volume_weighting": True}, "required": False},
    {"name": "volume_clustering_strength", "display_name": "Volume Clustering Strength",
     "description": "How strongly to cluster levels at high-volume zones (1.0-3.0)",
     "type": "float", "default": 1.5, "min_value": 1.0, "max_value": 3.0,
     "group": "volume_weighting",
     "visible_when": {"enable_volume_weighting": True}, "required": False},
    # ── Time Rotation ─────────────────────────────────────────────────────
    {"name": "enable_time_rotation", "display_name": "Enable Time-Based Profit Rotation",
     "description": "Periodically lock in profits and refresh grid",
     "type": "bool", "default": False,
     "group": "time_rotation", "required": False},
    {"name": "rotation_interval_hours", "display_name": "Rotation Interval (hours)",
     "description": "Time between profit-locking rotations",
     "type": "int", "default": 48, "min_value": 12, "max_value": 168,
     "group": "time_rotation",
     "visible_when": {"enable_time_rotation": True}, "required": False},
    {"name": "profit_lock_percent", "display_name": "Profit Lock Threshold (%)",
     "description": "Close positions with profit >= this percentage on rotation",
     "type": "float", "default": 70.0, "min_value": 0.0, "max_value": 100.0,
     "group": "time_rotation",
     "visible_when": {"enable_time_rotation": True}, "required": False},
    {"name": "min_profit_to_rotate", "display_name": "Minimum Profit to Trigger Rotation",
     "description": "Only rotate if total unrealized profit > this amount (0 = always rotate)",
     "type": "float", "default": 0.0, "min_value": 0.0, "max_value": 999999.0,
     "group": "time_rotation",
     "visible_when": {"enable_time_rotation": True}, "required": False},
]
...
class GridTradingStrategy(TradingStrategy):
    ...
    def get_definition(self) -> StrategyDefinition:
        ...
        return StrategyDefinition(
            ...
            parameters=[StrategyParameter(**p) for p in _GRID_PARAMS],
