...
INDICATOR_PARAMS = [
    ...
    {"name": "qfl_base_timeframe", "display_name": "QFL Base Timeframe",
     ...
     "options": ["ONE_HOUR", "TWO_HOUR", "SIX_HOUR", "ONE_DAY"],
     "group": "QFL"},
    {"name": "qfl_crack_timeframe", "display_name": "QFL Crack Timeframe",
     "description": "Timeframe used to detect the price crack (lower = faster entry)",
     "type": "str", "default": "FIFTEEN_MINUTE",
     "options": ["ONE_MINUTE", "FIVE_MINUTE", "FIFTEEN_MINUTE", "THIRTY_MINUTE"],
     "group": "QFL"},
    {"name": "qfl_lookback_candles", "display_name": "QFL Lookback Candles",
     "description": "Number of candles to scan for support bases",
     "type": "int", "default": 100, "min_value": 20, "max_value": 500,
     "group": "QFL"},
    {"name": "qfl_bounce_pct", "display_name": "QFL Min Bounce %",
     "description": "Minimum percentage bounce required to validate a base",
     "type": "float", "default": 3.0, "min_value": 0.5, "max_value": 20.0,
     "group": "QFL"},
    {"name": "qfl_crack_pct", "display_name": "QFL Crack %",
     "description": "Percentage below base to trigger entry",
     "type": "float", "default": 2.0, "min_value": 0.1, "max_value": 20.0,
     "group": "QFL"},
    # ── Bidirectional ─────────────────────────────────────────────────────
