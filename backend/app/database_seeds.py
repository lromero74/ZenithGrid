...
Default content sources, dead source lists, scrape policies,
and coin categories. Loaded by database.init_db() on startup.
"""
...
async def seed_default_sources(async_session_maker):
...
async def seed_default_coins(async_session_maker):
