...
from app.indicators.bull_flag_indicator import (
    BullFlagParams,
    BullFlagResult,
    BullFlagIndicatorEvaluator,
    evaluate_bull_flag_indicator,
    evaluate_bull_flag_indicator_with_details,
)
...
class TestBullFlagIndicatorEvaluator:
    ...
    @patch("app.strategies.bull_flag_scanner.detect_bull_flag_pattern")
    ...
    def test_exactly_10_candles_calls_detector(self):
        ...
        evaluator = BullFlagIndicatorEvaluator()
        with patch("app.strategies.bull_flag_scanner.detect_bull_flag_pattern") as mock_detect:
    ...
    def test_9_candles_does_not_call_detector(self):
        ...
        evaluator = BullFlagIndicatorEvaluator()
        with patch("app.strategies.bull_flag_scanner.detect_bull_flag_pattern") as mock_detect:
            evaluator.evaluate(candles=_make_candles(9), current_price=100.0)
